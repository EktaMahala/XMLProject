//This class is created as part of consumiing fellow groups API service
namespace MobileFoodSchedules
{
    ...
    public partial class MobileFoodSchedule
    {
        public static MobileFoodSchedule[] FromJson(string json) => JsonConvert.DeserializeObject<MobileFoodSchedule[]>(json, MobileFoodSchedules.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this MobileFoodSchedule[] self) => JsonConvert.SerializeObject(self, MobileFoodSchedules.Converter.Settings);
    }
